...
GIRL_NAMES.push(...['جلنار','زهرية','زكية','ساجدة','سحر','سعاد','سوسن','شادن','شامة','شفاء','شمس','صونيا','طيبة','عتاب','عذراء','عروب','عفاف','غدير','غنى','غزل','فدوى','فريال','فوزية','كاميليا','كنزي','لمياء','لميس','مادلين','ماريا','ماسة','ميسون','ميار','ميرنا','ناهد','نادين','نسرين','نغم','نهال','هاجر','هالة','وئام','واحة','وداد','وريف','وسن','وجدان','يمنى','سيلين','سيرين','لورين','ريتال','ريتاج','ريهام','رباب','رابعة','راضية','شهد','شوق','سناء','سنابل','عزيزة','عهود','غفراء','فجر','فتون','لؤلؤة','منى','منال','منيرة','نجلاء','نرجس','نورهان','وديعة','ياقوتة','ابتهاج','إحسان','حمدة','هتون','رنيم','رفيف','رُبى','رُقية','ريهانة','سميرة','سكينة','عطرة','أثير','أرواب','ألين','أريام','بشرى','بثينة','تماضر','تهاني','جواهر','حمدةان','حوراء','خزامى','ديمة','ديالا']);
BOY_NAMES.push(...['إيلياس','أيهم','أوس','أديب','أسامة','أشرف','أصيل','أمجد','أنور','أيوب','برهان','بهاء','تقي','تميم','توفيق','جبران','جودت','حسان','حارث','حبيب','حمد','حمدان','حمود','حيدر','خضر','داود','درويش','دياب','ذياب','رباح','رجب','رفيق','رماح','ركان','رؤوف','روحي','زكريا','زهير','زين','زين الدين','ساجد','ساهر','ساطع','سعدون','سطام','سلطان','سنان','شبل','شرف','شعلان','صهيب','طيب','عارف','عاطف','عاكف','عبادة','عبود','عديان','عزيز','عوني','غازي','غيث','غياث','فؤاد','فريد','فلاح','قتيبة','لطفي','لبيب','مجدي','مجد','مرهف','ممدوح','مهدي','موفق','منير','مهيب','نائل','ناصر الدين','نجيب','نزار','نضال','نعمان','نوح','هاشم','وديع','وهب','ياقوت','يامن','يعقوب','هلال','هارون','رشيد','رعد','رافع','راضي','رستم','ربيع','رائف','راغب','رامز','راغد','شاديان']);
OBJECTS.push(...['قلم رصاص','قلم حبر','مبراة','سبورة','طبشورة','طبشورة ملونة','منقلة','فرجار','مثلث هندسي','مسطرة معدنية','دفتر ملاحظات','كتاب مدرسي','ملف أوراق','حافظة أوراق','محفظة','حقيبة ظهر','حقيبة سفر','صندوق أدوات','علبة مناديل','منديل','منشفة','صابون','إسفنجة','فرشاة أسنان','معجون أسنان','مشط','نظارة','نظارة شمسية','إطار صورة','حامل هاتف','شاحن لاسلكي','بطارية متنقلة','سلك كهرباء','مشترك كهربائي','قابس','مصباح مكتبي','مصباح يدوي','شمعدان','مزهرية','أصيص نبات','سطل','دلو','مكنسة','ممسحة','جاروف','مجرفة','كماشة','زرادية','مثقاب','مفتاح ربط','برغي','صامولة','شريط لاصق','غراء','مقص أظافر','دبوس','مشبك ورق','مغلف رسالة','ظرف بريد','طرد','ملصق','بطاقة تعريف','ريموت تحكم','لوحة مفاتيح','فأرة لاسلكية','وحدة تخزين','فلاش','قرص صلب','ذاكرة خارجية','شريحة هاتف','هاتف أرضي','جهاز تحكم','جهاز إنذار','ميزان حرارة','ميزان مطبخ','ميزان حمام','آلة حاسبة','آلة تصوير','جهاز عرض','سماعة أذن','سماعة بلوتوث','مايكروفون مكتبي','حامل كتب','حامل أقلام','سلة مهملات','مروحة صغيرة','منظم أسلاك','وصلة كهرباء','محول كهرباء','مفتاح كهربائي','جرس','قنينة ماء','ترمس','وعاء','طبق تقديم','شوكة صغيرة','ملعقة صغيرة','سكين مطبخ','لوح تقطيع','مصفاة شاي','مبشرة','فتاحة علب','فتاحة زجاجات']);
...
export function startGame(guildId, channelId, type) {
  ...
  if (type === 'fakk') {
    ...
    const groups = [
      ['تفاح','موز','برتقال','سيارة'],
      ['قلم','دفتر','كتاب','موز'],
      ['سيارة','حافلة','قطار','تفاحة'],
      ['أحمر','أزرق','أخضر','كتاب'],
      ['قطة','كلب','حصان','طاولة'],
      ['ذهب','فضة','نحاس','تفاحة'],
      ['بحر','نهر','محيط','كرسي'],
      ['ورد','ياسمين','فل','سيارة'],
      ['صيف','شتاء','ربيع','مطرقة'],
      ['تفاحة','برتقال','موز','قلم'],
      ['طائرة','قطار','سيارة','تفاحة'],
      ['قهوة','شاي','عصير','كتاب'],
      ['أحمر','أصفر','أزرق','موز'],
      ['مطر','ثلج','برد','هاتف'],
      ['مكتب','كرسي','طاولة','برتقال'],
      ['أسد','نمر','فهد','حاسوب'],
      ['قمر','شمس','نجم','حقيبة'],
      ['ملعقة','شوكة','سكين','دراجة'],
      ['مستشفى','مدرسة','جامعة','تفاحة'],
      ['باب','نافذة','جدار','موز'],
      ['سيارة','حافلة','قطار','قلم'],
      ['كتاب','مجلة','جريدة','كرسي'],
      ['هاتف','حاسوب','كاميرا','برتقال'],
      ['طائرة','سفينة','قطار','قميص'],
      ['مطرقة','منشار','مفك','تفاحة'],
      ['ذهب','حديد','فضة','موز'],
      ['وردة','شجرة','نخلة','هاتف'],
      ['ملعب','مسبح','مسرح','قلم'],
      ['خبز','أرز','معكرونة','كتاب'],
      ['ليمون','برتقال','تفاح','كرسي'],
      ['سباحة','ركض','قفز','طاولة'],
      ['طبيب','مهندس','معلم','برتقال'],
      ['قميص','بنطال','حذاء','موز'],
      ['ليل','نهار','فجر','مقلاة'],
      ['مفتاح','قفل','باب','تفاحة'],
      ['قلم','رصاص','حبر','دراجة'],
      ['بقرة','غنم','ماعز','حاسوب'],
      ['نخلة','زيتون','تفاح','هاتف'],
  ...
  game.prompt = `**${game.prompt.replace(/\*\*/g, '')}**`;
