...
<body><main>
<div class="top"><div><h1>Infinity Security</h1><div class="muted">Anti-Nuke \u2022 Anti-Raid \u2022 Mass Role Protection \u2022 Advanced AutoMod \u2022 Escalation \u2022 Whitelist</div></div><div id="guildName" class="muted"></div></div>
...
<div class="row"><span>Mass Role Assign</span><input id="massRole" type="checkbox"></div>
...
<label class="field"><span>Lockdown duration (minutes)</span><input id="nukeLockdownMinutes" type="number" min="1"></label>
...
<section class="card"><h2>Mass Role Assign</h2>
<label class="field"><span>Members threshold</span><input id="massRoleThreshold" type="number" min="2"></label>
<label class="field"><span>Detection window (ms)</span><input id="massRoleWindow" type="number" min="1000"></label>
<label class="field"><span>Response action</span><select id="massRoleAction"><option value="strip">Strip dangerous roles</option><option value="timeout">Timeout</option><option value="kick">Kick</option><option value="ban">Ban</option></select></label>
<label class="field"><span>Lockdown duration (minutes)</span><input id="massRoleLockdownMinutes" type="number" min="1"></label>
<div class="row"><span>Lockdown on trigger</span><input id="massRoleLockdown" type="checkbox"></div>
<div class="notice">Detects when someone assigns dangerous roles (Admin, Ban, Kick, ManageChannels, ManageRoles, ManageWebhooks) to multiple members in a short window.</div>
</section>
...
<div class="notice">Whitelisted users/roles/bots bypass Anti-Nuke, Anti-Raid, Mass Role and AutoMod. The guild owner is always protected.</div>
</section>
</div>
